function myForm(){
	...
	//i made a function for my form on the contact page to validate weather or not the person has properly filled out the form section correctly.
	...
	if (document.getElementById("rainbowcolor").value == "" || null){
	alert("Please pick a color");
	valid = false;
	console.log("failed rainbowcolor");
	}
